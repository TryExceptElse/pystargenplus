...
void init(void);
void generate_stellar_system(planets**, sun*, int, planet_pointer, char, int, char *, long double, long double, long double, long double, int, int); // seb add inner dust limit& ecc_coef, inner_planet_factor
			     ...
			     int			do_moons)
{
	...
	*/
	...
	generate_planets(*innermost_planet,
	                 sun,
					 !use_seed_system,
					 flag_char,
					 sys_no,
...
void generate_planets(planet_pointer    innermost_planet,
                      sun*			    sun,
					  int 			    random_tilt,
					  char			    flag_char,
					  int			    sys_no,
